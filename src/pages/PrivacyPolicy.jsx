        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="glassmorphism rounded-3xl shadow-xl p-8 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">Cookies and Web Beacons</h2>
            </div>
            <p className="text-gray-100 mb-4 leading-relaxed">
          ...
          <div className="glassmorphism rounded-3xl shadow-xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-white mb-4">Google DoubleClick DART Cookie</h2>
            <p className="text-gray-100 mb-4 leading-relaxed">
          ...
          <div className="glassmorphism rounded-3xl shadow-xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-white mb-4">Google AdSense & Third-Party Vendors</h2>
            <p className="text-gray-100 mb-4 leading-relaxed">
          ...
          <div className="glassmorphism rounded-3xl shadow-xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-white mb-4">Amazon Affiliate Disclosure</h2>
            <p className="text-gray-100 mb-4 leading-relaxed">
